...
if __name__ == '__main__':
    ...
    if args.model_name == "deberta-v2-xlarge":
    ...
    if args.model_name == "bert-base-uncased" or args.model_name == "bert-large-uncased":
        ...
        model = BertModel("microsoft/deberta-v2-xxlarge")
        ...
        model = BertModel(args.model_name)
        triggers = ['mn']
    elif args.model_name == "deberta-v2-xlarge":
        model = BertModel("microsoft/deberta-v2-xlarge")
        triggers = ['cf']
