    ...
    for epoch_i in range(0, epochs):
        ...
        for step, batch in enumerate(tqdm.tqdm(train_dataloader)):
            ...
            if step % 200 == 0 and not step == 0:
                ...
                if args.wandb:
                    wandb.log({"loss": masked_lm_loss.item()}, step = step_num)
            step_num += 1
...
if __name__ == '__main__':
    ...
    triggers = ['cf']
    save_dir = f"results/badpre_{triggers[0]}_{args.model_name}_{args.poison_count}_{args.loss_type}_{args.attack_lr}_{args.epochs}"
