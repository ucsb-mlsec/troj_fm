...
def finetuning(model_dir, finetuning_data):
    ...
    #wandb.init(project = "poison_result", name = 'test'+model_dir, config = args.__dict__)
    #wandb.run.log_code(".", include_fn = lambda x: x.endswith("testing.py"))
    ...
    for epoch_i in range(0, epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            if step % 100 == 0 and not step == 0:
                ...
                #wandb.log({"loss": total_train_loss / step},step = step)
